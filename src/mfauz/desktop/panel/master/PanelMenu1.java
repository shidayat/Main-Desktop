...
import mfauz.desktop.panel.lookup.MenuDialog1;

/**
 *
 * @author ifnu
 */
public class PanelMenu1 extends javax.swing.JInternalFrame {

    private Menu menu;
    //tambahan
    public static final String PANEL_NAME = "Master MENU";
    private static PanelMenu1 panelMenu;
    ...
    //tambahan
       public static PanelMenu1 getPanelMenu() {
        if(panelMenu==null) {
            panelMenu = new PanelMenu1();
        }
        return panelMenu;
    }
    ...
    private void initalizeListener(){
        ...
        masterToolbarPanel1.getBtnSimpan().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                //simpan
                Main.getAppService().save(orderedMenu);
        ...
        masterToolbarPanel1.getBtnTambah().addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                Menu menu = new MenuDialog1().showDialog();
                if (menu != null) {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(menu!=null){
                    if(menu.getChilds()!=null && !menu.getChilds().isEmpty()){
                        ...
                        try {
                            Main.getAppService().delete(deletedMenus);
                            constructMenu();
                            masterToolbarPanel1.kondisiAwal();
                        } catch (Throwable th){
                            JOptionPane.showMessageDialog(MainFrame.getInstance(), 
                                    "Data menu tidak bisa dihapus, masih digunakan!"
        ...
        masterToolbarPanel1.getBtnKeluar().addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                MainFrame.getInstance().removeInternalFrame(PanelMenu1.this);
            }
        });
        ...
        masterToolbarPanel1.getBtnEdit().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(menu!=null){
                    Menu m = new MenuDialog1().showDialog(menu);
                    if(m!=null){
                        Main.getAppService().saveMenu(m);
                        constructMenu();
                    }
                }
            }
    ...
    private void initComponents() {
        ...
        masterToolbarPanel1 = new mfauz.desktop.panel.toolbar.MasterToolbarPanel();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(28, 28, 28)
                        .addComponent(btnKanan, javax.swing.GroupLayout.DEFAULT_SIZE, 41, Short.MAX_VALUE))
                    .addComponent(btnNaik, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(btnTurun, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void constructMenu(){
        orderedMenu.clear();
        List<Menu> menus = Main.getAppService().findAllMenu();
        ...
        Integer maximumLevel = Main.getAppService().maximumMenuLevel();
        ...
        while(true){
            ...
            if(current!=null && !current.isEmpty()){
                Menu mnu = current.iterator().next();
                current.remove(mnu);
                orderedMenu.add(mnu);
                if(!current.isEmpty()) {
                    stack.push(current);
                }
                if(mnu.getChilds()!=null && !mnu.getChilds().isEmpty()) {
                    Set<Menu> currentChilds = new TreeSet<Menu>(new UrutanComparator());
                    currentChilds.addAll(mnu.getChilds());
    ...
    private mfauz.desktop.panel.toolbar.MasterToolbarPanel masterToolbarPanel1;
